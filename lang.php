<?php
function getLang() {
    $supportedLangs = json_decode(file_get_contents('/var/www/html/lang.json'), true)['langs'];
...
function getString($id) {
    $lang = getLang();
    $langIndex = array_search($lang, json_decode(file_get_contents('/var/www/html/lang.json'), true)['langs']);
    $strings =  json_decode(file_get_contents('/var/www/html/lang.json'), true)['pack'];
